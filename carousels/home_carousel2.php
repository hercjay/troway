...
<div id="home_carousel2" class="carousel slide carousel-fade" data-ride="carousel">
    ...
    <!-- <a class="carousel-control-prev" href="#home_carousel2" role="button" data-slide="prev">
        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
        <span class="sr-only">Previous</span>
    </a>
    <a class="carousel-control-next" href="#home_carousel2" role="button" data-slide="next">
